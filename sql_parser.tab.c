...
#line 1295 "sql_parser.tab.c"
    break;

  case 3: /* statements: statement  */
#line 84 "src/sql/sql_parser.y"
              {
        // 只有一个语句，创建一个列表节点，并把该语句作为子节点
        (yyval.node) = new ASTNode(ROOT_NODE, "", (yyloc));
        (yyval.node)->addChild((yyvsp[0].node));
    }
#line 1305 "sql_parser.tab.c"
    break;

  case 4: /* statements: statements statement  */
#line 89 "src/sql/sql_parser.y"
                           {
...
#line 98 "src/sql/sql_parser.y"
                         { (yyval.node) = (yyvsp[-1].node); }
#line 1321 "sql_parser.tab.c"
    break;

  case 6: /* statement: insert_statement ';'  */
#line 99 "src/sql/sql_parser.y"
                           { (yyval.node) = (yyvsp[-1].node); }
#line 1327 "sql_parser.tab.c"
    break;

  case 7: /* statement: select_statement ';'  */
#line 100 "src/sql/sql_parser.y"
                           { (yyval.node) = (yyvsp[-1].node); }
#line 1333 "sql_parser.tab.c"
    break;

  case 8: /* statement: delete_statement ';'  */
#line 101 "src/sql/sql_parser.y"
                           { (yyval.node) = (yyvsp[-1].node); }
#line 1339 "sql_parser.tab.c"
    break;

  case 9: /* statement: error ';'  */
#line 102 "src/sql/sql_parser.y"
                { yyerrok; }
#line 1345 "sql_parser.tab.c"
    break;

  case 10: /* create_statement: K_CREATE K_TABLE IDENTIFIER '(' column_definitions ')'  */
#line 109 "src/sql/sql_parser.y"
                                                           {
...
#line 1433 "sql_parser.tab.c"
    break;

  case 19: /* select_list: '*'  */
#line 174 "src/sql/sql_parser.y"
        { 
...
#line 242 "src/sql/sql_parser.y"
                { (yyval.node) = nullptr; }
#line 1526 "sql_parser.tab.c"
    break;

  case 29: /* optional_column_list: '(' column_list ')'  */
#line 243 "src/sql/sql_parser.y"
                          { (yyval.node) = (yyvsp[-1].node); }
#line 1532 "sql_parser.tab.c"
    break;

  case 30: /* value_list: value  */
#line 247 "src/sql/sql_parser.y"
          {
...
#line 251 "src/sql/sql_parser.y"
                           {
        (yyvsp[-2].node)->addChild((yyvsp[0].node));
        (yyval.node) = (yyvsp[-2].node);
    }
#line 1550 "sql_parser.tab.c"
    break;

  case 32: /* value: literal  */
#line 258 "src/sql/sql_parser.y"
            { (yyval.node) = (yyvsp[0].node); }
#line 1556 "sql_parser.tab.c"
    break;

  case 33: /* delete_statement: K_DELETE K_FROM IDENTIFIER optional_where_clause  */
#line 264 "src/sql/sql_parser.y"
                                                     {
...
#line 300 "src/sql/sql_parser.y"
                   {
        (yyval.node) = new ASTNode(STRING_LITERAL_NODE, (yyvsp[0].str_val), (yylsp[0]));
        free((yyvsp[0].str_val));
    }
#line 1633 "sql_parser.tab.c"
    break;


#line 1637 "sql_parser.tab.c"
